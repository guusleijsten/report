...
\begin{figure}[b!]
\centering
\subfloat[Data path with implicit bypassing.]{\includegraphics[width=.445\textwidth]{figures/transparent_bypass}%
\label{fig:transparent_datapath}}
\hfil
\subfloat[Data path with explicit bypassing.]{\includegraphics[width=.445\textwidth]{figures/explicit_bypass}%
