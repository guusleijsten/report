...
Trivially, it is not possible to allocate explicit bypasses before scheduling, because one needs a schedule to do explicit bypass allocation. %the order of instructions is not known at that time. 
